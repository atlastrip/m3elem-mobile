...
import { FontAwesome, MaterialIcons } from "@expo/vector-icons"; // Using Expo's icon library for the star ratings
import MessageOutlinedIcon from "@expo/vector-icons/MaterialIcons";
import CallOutlinedIcon from "@expo/vector-icons/MaterialIcons";
import { useNavigation } from "@react-navigation/native"; // React Navigation
import Constants from "expo-constants";
...
const DisplayServiceProviders = ({ data, navigation, selectedCategories, title, chatType }: any) => {
    ...
    const [userId, setUserId]: any = useState(null);
    const [isServicesCollapsed, setIsServicesCollapsed] = useState(true);
    const [selectedChatType, setSelectedChatType] = useState(chatType || "chat"); // Initialize with chatType prop
    ...
    return (
        <ScrollView >
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTextContainer}>
                    ...
                    <View className='flex-row'>
                        <ShareLink url={"https://www.m3alempro.com/en/profile/pro/" + data?.userByPK?.id} />
                    </View>
                </View>
            </View>
            ...
            {/* Average Rating */}
            <AverageRatingDisplay reviews={data?.userByPK?.reviews} />
            ...
            <View style={styles.chatCallContainer}>
                <TouchableOpacity
                    style={[
                        ...
                        selectedChatType === "chat" && styles.selectedButton,
                    ]}
                    onPress={() => setSelectedChatType("chat")}
                >
                    <MaterialIcons name="chat" size={18} color={
                    ...
                    <Text
                        style={[
                            styles.chatCallButtonText,
                            selectedChatType === "chat" && styles.selectedButtonText,
                        ]}
                    >
                        Chat
                    </Text>
                ...
                <TouchableOpacity
                    style={[
                        styles.chatCallButton,
                        selectedChatType === "call" && styles.selectedButton,
                    ]}
                    onPress={() => setSelectedChatType("call")}
                >
                    <MaterialIcons name="phone" size={18} color={
                        selectedChatType === "call" ?
                            'white' : COLORS.primary
                    ...
                    <Text
                        style={[
                            styles.chatCallButtonText,
                            selectedChatType === "call" && styles.selectedButtonText,
                        ]}
                    >
                        Call
                    </Text>
            ...
            {/* <Button
                ...
                onPress={() => {
                    ...
                    console.log('====================================');
                    handleContact(selectedChatType);
                }}
            /> */}
            <TouchableOpacity
