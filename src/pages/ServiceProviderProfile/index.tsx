...
const styles = StyleSheet.create({
    ...
    // },
    // chatButton: {
    //     backgroundColor: "#3a7f41", // Green background for Chat
    //     color: ' white'
    // },
    // callButton: {
    //     backgroundColor: "#fff", // White background for Call
    // },
    // selectedButton: {
    //     borderWidth: 2,
    //     borderColor: "#3a7f41", // Green border when selected
    // },
    // chatCallButtonText: {
    //     fontSize: 16,
    //     fontWeight: "bold",
    ...
    // },
    // callButtonText: {
    //     color: "#3a7f41", // Green text for Call button
    // },
    // selectedButtonText: {
    //     color: "#3a7f41", // Green text when selected (if needed)
    // },
    chatCallContainer: {
        flexDirection: 'row',
        justifyContent: 'center',
