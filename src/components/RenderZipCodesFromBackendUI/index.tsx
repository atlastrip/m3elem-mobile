...
//     if (!userData || !userData.user || data.length === 0) {
//         return (
...
//     const baseUrl = 'https://yourwebsite.com'; // Replace with your actual base URL

//     return (
//         <ScrollView contentContainerStyle={styles.container}>
//             <>
//                 <View style={styles.header}>
//                     <Title>Choose where you work.</Title>
//                     <Paragraph>
...
//                             onPress={() =>
//                                 Linking.openURL(
//                                     `${baseUrl}/en/zipcodes/zip-code-finder?zipcode=${userData.user.zipCodeHome}&miles=${userData.user.miles}`
//                                 )
//                             }
//                         >
...
// RenderZipCodesFromBackendUI.tsx
...
//     const [milesInput, setMilesInput] = useState<string>(userData.user.miles || '20');
...
//         if (!zipCodeInput || !milesInput) {
//             Alert.alert('Error', 'Please enter both ZIP code and range in miles.');
//             return;
//         }
...
//             // Replace with your actual mutation to update user location
